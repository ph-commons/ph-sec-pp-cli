...
import (
	...
	mcptools "github.com/ph-commons/ph-sec-pp-cli/internal/mcp"
)
...
func main() {
	...
	_ = os.Setenv("PH_SEC_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "ph-sec-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
