...
large datasets as it has no memory pressure.`,
  ...
  ph-sec-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  ph-sec-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  ph-sec-pp-cli export <resource> --format jsonl | jq '.id'`,
