...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("PH_SEC_STATE_DIR", "")
	t.Setenv("PH_SEC_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"ph-sec-pp-cli auth login",
		"ph-sec-pp-cli doctor",
		"ph-sec-pp-cli help items",
		"ph-sec-pp-cli sync",
		"ph-sec-pp-cli profile list",
		"ph-sec-pp-cli feedback list",
		"ph-sec-pp-cli which",
		"ph-sec-pp-cli agent-context",
		"ph-sec-pp-cli completion bash",
		"ph-sec-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"ph-sec-pp-cli teach",
		"ph-sec-pp-cli recall",
		"ph-sec-pp-cli learnings",
		"ph-sec-pp-cli teach-pattern",
		"ph-sec-pp-cli teach-lookup",
		"ph-sec-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("ph-sec-pp-cli")); err == nil {
